...
#define CT_OFFSET_PROT ((uint64_t)20 << 10)     // 20KB
#define CT_OFFSET_L9_BMP ((uint64_t)40 << 10)   // 40KB
#define CT_OFFSET_1_PGG                                                        \
  ((uint64_t)0x01 << 39)  // 512GB the first page group used to store file
// #define CT_OFFSET_PATH_HASH                                                    \
//   (((uint64_t)0x01 << 39) -                                                    \
//    ((uint64_t)2 << 20))  // 512GB-2MB ,path2inode hash table
// #define CT_OFFSET_PATH_HASH_LOCK                                               \
//   (((uint64_t)0x01 << 39) -                                                    \
//    ((uint64_t)1 << 20))  // 512GB-2MB ,path2inode hash table
...
#define PUD_SHIFT 30
#define PUD_SIZE (((uint64_t)0x01) << PUD_SHIFT)
// errors
...
// #define PTHREAD_RWLOCK  // use pthread rwlock
#define DIY_MUTEX  // use DIY mutex
#endif